...
// ------------------    GRADIENT BORDERS   ---------------------
// --------------------------------------------------------------
// KEY DIFFERENCE BETWEEN TNO AND VANILLA
static const float GB_CAM_MIN = 0.0f; // How strong the terrain effects are
static const float GB_CAM_MAX = 1.0f; // How strong the terrain effects are
// How "pure-color" / dark the map colors are
