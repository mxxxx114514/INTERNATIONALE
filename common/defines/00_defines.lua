...
NMilitary = {
	...
	SUPPLY_GRACE = 120,							   -- troops always carry 5 days of food and supply (Vanilla 3 days)
...
NAir = {
	...
	STRATEGIC_BOMBING_STATE_BUILDING_SCALE = 1.0,					-- The scale of state building priority for strategic bombingNGeography
...
NSupply = {
	...
	NODE_STARTING_PENALTY_PER_PROVINCE = 0.5,
	NODE_ADDED_PENALTY_PER_PROVINCE = 0.6,
	...
	RAILWAY_CONVERSION_COOLDOWN_CORE = 1,
